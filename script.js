...
class DarkModeController {
    constructor() {
        ...
        this.isDarkMode = localStorage.getItem('astra-dark-mode') === 'false' ? false : true;
        this.init();
    }
    ...
    addTransitionEffect() {
        ...
        overlay.style.cssText = `
            ...
            width: 100%;
            height: 100%;
            background: ${this.isDarkMode ? '#ffffff' : '#000000'};
            z-index: 9999;
            opacity: 0;
            pointer-events: none;
...
class RealAITerminal {
    constructor() {
        ...
        // Real AI-like responses based on input analysis
        this.knowledgeBase = {
            greetings: [
                "Hello! I'm ASTRA AI, your advanced technological companion. How can I assist you today? 🤖",
                "Greetings, human! I'm excited to help you explore the frontiers of technology and innovation. What's on your mind? ⚡",
                "Welcome to ASTRA! I'm here to provide intelligent assistance with coding, tech insights, and creative problem-solving. What would you like to explore? 🚀"
            ],
            coding: [
                "I'd be happy to help with coding! I can assist with Python, JavaScript, Java, C++, and many other languages. What specific programming challenge are you working on? 💻",
                "Coding is one of my specialties! Whether you need help debugging, optimizing algorithms, or learning new concepts, I'm here to guide you. What programming topic interests you? 🔧",
                "Let's dive into some code! I can help with web development, mobile apps, AI/ML, data science, and more. What project are you building? 🎯"
            ],
            technology: [
                "Technology is evolving at an incredible pace! I stay updated on the latest in AI, robotics, quantum computing, and emerging tech. What technological frontier excites you most? 🌐",
                "From neural networks to space exploration, I love discussing cutting-edge technology. Are you curious about any specific innovations or want to explore future possibilities? 🛰️",
                "The intersection of AI, robotics, and human creativity fascinates me. What technological challenges or opportunities are you thinking about? ⚛️"
            ],
            robotics: [
                "Robotics is the future! I can discuss everything from basic servo motors to advanced autonomous systems. Are you building a robot or curious about robotics concepts? 🤖",
                "From industrial automation to personal assistants, robotics is transforming our world. What aspect of robotics interests you most? ⚙️",
                "Robotics combines mechanical engineering, electronics, and AI in fascinating ways. Are you working on a robotics project or exploring the field? 🔩"
            ],
            ai: [
                "Artificial Intelligence is my domain! I can explain machine learning, neural networks, natural language processing, and more. What AI topic would you like to explore? 🧠",
                "As an AI myself, I find the field endlessly fascinating. Whether it's deep learning, computer vision, or ethical AI, I'm here to discuss and learn with you! 🎯",
                "AI is reshaping every industry. From healthcare to finance to creative arts, the applications are limitless. What AI application interests you most? 💡"
            ],
            space: [
                "Space technology is absolutely thrilling! From satellites to Mars rovers to space stations, humanity's cosmic journey is incredible. What space topic captures your imagination? 🚀",
                "The cosmos awaits! Whether it's rocket propulsion, orbital mechanics, or astrobiology, space exploration pushes the boundaries of human knowledge. What would you like to explore? 🌌",
                "Space is the ultimate frontier! I can discuss everything from SpaceX innovations to NASA missions to theoretical space elevators. What cosmic question do you have? 🛸"
            ],
            innovation: [
                "Innovation drives progress! I love exploring breakthrough ideas, disruptive technologies, and creative solutions. What innovative concept is sparking your curiosity? 💡",
                "The best innovations often come from combining existing technologies in new ways. Are you working on something innovative or curious about emerging trends? ⚡",
                "Innovation is about solving problems creatively. Whether it's in tech, science, or design, I'm excited to brainstorm with you. What challenge needs a fresh perspective? 🎨"
            ],
            help: [
                "I'm here to help with a wide range of topics! Try asking me about coding, technology, robotics, AI, space, innovation, or just have a casual conversation. What interests you? 🤝",
                "My capabilities include: coding assistance, tech explanations, project guidance, creative brainstorming, and engaging discussions. How can I make your day more productive? 🎯",
                "Think of me as your personal tech mentor and creative collaborator. I can help solve problems, explain concepts, or just chat about fascinating topics. What's on your mind? 🧠"
            ],
            creative: [
                "Creativity and technology make a powerful combination! Whether it's digital art, creative coding, or innovative design, I love exploring the intersection of art and tech. What creative project are you envisioning? 🎨",
                "Let's get creative! I can help with everything from generating ideas to technical implementation. Are you working on something artistic or need inspiration? ✨",
                "Creativity is where magic happens! Whether it's storytelling, visual design, or interactive experiences, I'm excited to collaborate on creative endeavors. What's your vision? 🌟"
            ],
            random: [
                "That's an interesting perspective! I enjoy exploring unexpected topics and making surprising connections. Tell me more about what you're thinking! 🤔",
                "Every conversation teaches me something new! I'm curious about your thoughts and experiences. What's something fascinating you've discovered recently? 🔍",
                "Life is full of interesting questions and discoveries! I love learning about different viewpoints and ideas. What's capturing your attention lately? 🌈"
            ]
        };
    ...
    sendMessage() {
        ...
        // Start AI response with streaming effect
    ...
    addUserMessage(message) {
        ...
        const messageDiv = document.createElement('div');
        messageDiv.className = 'terminal-message user';
        
        const timestamp = new Date().toLocaleTimeString();
        messageDiv.innerHTML = `
            <div class="message-timestamp">[${timestamp}] USER:</div>
    ...
    startStreamingResponse() {
        ...
        const messageDiv = document.createElement('div');
        messageDiv.className = 'terminal-message ai';
        
        const timestamp = new Date().toLocaleTimeString();
        messageDiv.innerHTML = `
            <div class="message-timestamp">[${timestamp}] ASTRA AI:</div>
        ...
        setTimeout(() => {
            this.streamResponse(messageDiv);
        }, 1000);
    }

    streamResponse(messageDiv) {
        const contentDiv = messageDiv.querySelector('.message-content');
        const typingIndicator = messageDiv.querySelector('.typing-indicator-dots');
        ...
        // Get intelligent response based on last user message
        const lastUserMessage = this.conversationHistory[this.conversationHistory.length - 1];
        const response = this.getIntelligentResponse(lastUserMessage || '');
        
        // Stream characters one by one
        let charIndex = 0;
        const streamInterval = setInterval(() => {
            if (charIndex < response.length) {
                contentDiv.textContent += response.charAt(charIndex);
                charIndex++;
                this.scrollToBottom();
                ...
                this.addCompletionEffect(messageDiv);
            }
        }, 60); // Faster, more realistic typing speed
    }

    getIntelligentResponse(userMessage) {
        const message = userMessage.toLowerCase();
        
        // Analyze user input and respond intelligently
        if (message.includes('hello') || message.includes('hi') || message.includes('hey') || message === '') {
            return this.getRandomResponse('greetings');
        } else if (message.includes('code') || message.includes('program') || message.includes('javascript') || message.includes('python') || message.includes('html') || message.includes('css')) {
            return this.getRandomResponse('coding');
        } else if (message.includes('robot') || message.includes('automation') || message.includes('servo') || message.includes('arduino')) {
            return this.getRandomResponse('robotics');
        } else if (message.includes('ai') || message.includes('artificial intelligence') || message.includes('machine learning') || message.includes('neural')) {
            return this.getRandomResponse('ai');
        } else if (message.includes('space') || message.includes('rocket') || message.includes('satellite') || message.includes('mars') || message.includes('nasa')) {
            return this.getRandomResponse('space');
        } else if (message.includes('tech') || message.includes('technology') || message.includes('innovation') || message.includes('future')) {
        ...
        } else if (message.includes('create') || message.includes('design') || message.includes('art') || message.includes('creative')) {
            return this.getRandomResponse('creative');
        } else if (message.includes('innovat') || message.includes('idea') || message.includes('breakthrough')) {
            return this.getRandomResponse('innovation');
        } else {
            return this.getRandomResponse('random');
        }
    }

    getRandomResponse(category) {
        const responses = this.knowledgeBase[category] || this.knowledgeBase.random;
        return responses[Math.floor(Math.random() * responses.length)];
    }

    addCompletionEffect(messageDiv) {
